    ...
    public partial class Pager : UserControl
    {
        ...
        private void btnGo_Click(object sender, EventArgs e)
        {
            if (this.txtCurrentPage.Text != null && txtCurrentPage.Text != "")
            {
                ...
                {
                    if (Convert.ToInt32(txtCurrentPage.Text) > _pageCurrent || Convert.ToInt32(txtCurrentPage.Text) <=0)
                    {
                        this.PageCurrent = 1;
                    }
                    this.Bind();
                ...
                else
                {
                    ...
                    Bouwa.Helper.MessageBoxForm.Show("输入数字格式错误", MessageBoxButtons.OK);
                }
            }
        }
